...
class Producto extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['num_inventario', 'name', 'area_id','tipo_id','fecha_alta','marca_id','user_id','status_id','modelo_id','num_serie','categoria_id','subcategoria_id','ubicacion','imagen'];
